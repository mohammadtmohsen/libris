...
export const OverlayLoader = ({
  ...
  return (
    <div
      className='fixed inset-0 z-30 flex items-center justify-center px-4 sm:px-6'
      role='status'
      aria-live='polite'
    >
      ...
      <div className='relative w-full max-w-5xl overflow-hidden rounded-secondary border border-white/12 bg-gradient-to-b from-blue-5/90 via-black-4/90 to-black-5/95 shadow-[0_30px_120px_rgba(0,0,0,0.6)]'>
        ...
        <div className='relative flex flex-col gap-6 p-6 text-white sm:flex-row sm:items-center sm:justify-between sm:gap-8 sm:p-10'>
